...
// .wrangler/tmp/bundle-pX871f/checked-fetch.js
...
// .wrangler/tmp/bundle-pX871f/strip-cf-connecting-ip-header.js
...
function renderSpeedtestPage(target) {
  ...
  return SPEEDTEST_HTML.replace("{{TARGET}}", escapeForHtml(cleanTarget)).replace("{{RESULT}}", escapeForHtml(output));
}
...
// .wrangler/tmp/bundle-pX871f/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pX871f/middleware-loader.entry.ts
