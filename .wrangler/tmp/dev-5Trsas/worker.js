...
// .wrangler/tmp/bundle-gqo5Wt/checked-fetch.js
...
// .wrangler/tmp/bundle-gqo5Wt/strip-cf-connecting-ip-header.js
...
function makeRow(entry) {
  const dataHtml = (entry.data || "").replace(/\n/g, "<br>").replace(/🚨/g, '<span style="color:#ff5a5a; font-size:1.8em; font-weight:bold;">\u{1F6A8}</span>');
  return `
    <tr>
...
// .wrangler/tmp/bundle-gqo5Wt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gqo5Wt/middleware-loader.entry.ts
